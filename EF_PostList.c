...
static PostFunc * const List00[] = {PostmorseElementsSM };
static PostFunc * const List01[] = {PostmorseElementsSM };
static PostFunc * const List02[] = {PostmorseDecodeSM};
static PostFunc * const List03[] = {PostmorseElementsSM, PostmorseDecodeSM };
static PostFunc * const List04[] = {PostmorseElementsSM };
static PostFunc * const List05[] = {PostmorseElementsSM };
static PostFunc * const List06[] = {PostmorseElementsSM };
static PostFunc * const List07[] = {PostmorseElementsSM };

...
{ {InitmorseElementsSM, PostmorseElementsSM, IsmorseElementsSMQEmpty, RunmorseElementsSM }, /* highest priority */
  {InitmorseDecodeSM, PostmorseDecodeSM, IsmorseDecodeSMQEmpty, RunmorseDecodeSM }};
